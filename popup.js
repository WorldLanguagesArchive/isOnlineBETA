window.onload = function() {
    ...
    else{document.getElementById("settings").remove();document.getElementById("anote").innerHTML="<small>"+chrome.i18n.getMessage("friendlistdescription")+"</small>";document.getElementById("newlines").remove();return;}
